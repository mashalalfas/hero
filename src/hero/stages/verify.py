...
Thin wrapper around :func:`hero.commands.verify.run_verify`.
...
from hero.commands.verify import run_verify as _run_verify


def run_verify(sandbox_path: Path, verbose: bool = False, **kwargs: Any) -> dict[str, Any]:
    ...
    **kwargs
    ...
    dict
        ...
        ``checks``, and ``findings``.
    """
    return _run_verify(sandbox_path, verbose=verbose, **kwargs)
